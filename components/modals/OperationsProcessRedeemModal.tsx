...
export function OperationsProcessRedeemModal({ open, onClose, row, loading, onConfirm }: Props) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Process Redeem Request">
      <div className="space-y-4">
        <p className="text-sm text-gray-400">
          Are you sure you want to process this redeem request? It will be sent to the Verification department.
        </p>
