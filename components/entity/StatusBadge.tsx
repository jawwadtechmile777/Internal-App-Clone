...
export function StatusBadge({ status }: StatusBadgeProps) {
  ...
  else if (key.includes("processing")) cls = "bg-blue-900/40 text-blue-200 border border-blue-800";
  else if (key.includes("verified")) cls = "bg-teal-900/40 text-teal-200 border border-teal-800";
  ...
  else if (key.includes("pending") || key.includes("waiting") || key.includes("verification")) cls = "bg-amber-900/30 text-amber-200 border border-amber-800";
